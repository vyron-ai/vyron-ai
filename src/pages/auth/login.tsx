...
import { Eye, EyeOff, Loader2, AlertCircle, Settings2, FlaskConical } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4 relative overflow-hidden dark">
      ...
      <div className="glass-strong border border-border w-full max-w-md p-8 rounded-2xl relative z-10 flex flex-col gap-6">
        ...
        {/* Setup banner — only when Supabase not configured */}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-primary/40 bg-primary/10 text-primary hover:bg-primary/20 hover:border-primary/60 transition-all font-semibold text-sm electric-glow"
        ...
        <div className="relative flex items-center">
          ...
          <span className="flex-shrink-0 mx-4 text-muted-foreground text-xs uppercase tracking-wider">or sign in</span>
          <div className="flex-grow border-t border-border" />
        </div>
